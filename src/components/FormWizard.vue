<template>
  <div class="vue-form-wizard modal-card" :class="stepSize">
    <div class="modal-card-head">
      <div class="tabs is-fullwidth">
        <ul>
          <slot name="step" v-for="(tab, index) in tabs" :tab="tab" :index="index" :navigate-to-tab="navigateToTab" :step-size="stepSize" :transition="transition">
            <wizard-step :tab="tab" :step-size="stepSize" :max-step="maxStep" @click.native="navigateToTab(index)" :transition="transition" :index="index">
            </wizard-step>
          </slot>
        </ul>
      </div>
    ...
    <div class="modal-card-foot level is-mobile" v-if="!hideButtons">
        ...
        <div class="level-right">
          ...
          <div class="level-item">
            <span @click="nextTab" v-if="isLastStep">
              <slot name="finish" v-bind="slotProps"></slot>
            </span>
            <span @click="nextTab" v-if="!isLastStep">
